 ...
 */
export function instanceOfUpdateSkillRequest(
  value: object,
): value is UpdateSkillRequest {
  return true;
}
...
export function UpdateSkillRequestFromJSONTyped(
  json: any,
...
export function UpdateSkillRequestToJSONTyped(
  value?: UpdateSkillRequest | null,
