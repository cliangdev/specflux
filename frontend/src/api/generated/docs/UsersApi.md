...
|------------- | ------------- | -------------|
| [**getCurrentUser**](UsersApi.md#getcurrentuser) | **GET** /api/users/me | Get current authenticated user |
| [**getUser**](UsersApi.md#getuser) | **GET** /api/users/{ref} | Get user by public ID |
| [**updateCurrentUser**](UsersApi.md#updatecurrentuser) | **PUT** /api/users/me | Update current user profile |
