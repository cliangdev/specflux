...
|------------- | ------------- | -------------|
| [**createRelease**](ReleasesApi.md#createreleaseoperation) | **POST** /api/projects/{projectRef}/releases | Create a new release |
| [**deleteRelease**](ReleasesApi.md#deleterelease) | **DELETE** /api/projects/{projectRef}/releases/{releaseRef} | Delete a release |
| [**getRelease**](ReleasesApi.md#getrelease) | **GET** /api/projects/{projectRef}/releases/{releaseRef} | Get a release |
| [**listReleases**](ReleasesApi.md#listreleases) | **GET** /api/projects/{projectRef}/releases | List releases in a project |
| [**updateRelease**](ReleasesApi.md#updatereleaseoperation) | **PUT** /api/projects/{projectRef}/releases/{releaseRef} | Update a release |
