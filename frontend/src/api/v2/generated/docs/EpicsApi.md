...
|------------- | ------------- | -------------|
| [**addEpicDependency**](EpicsApi.md#addepicdependencyoperation) | **POST** /projects/{projectRef}/epics/{epicRef}/dependencies | Add a dependency to an epic |
| [**createEpic**](EpicsApi.md#createepicoperation) | **POST** /projects/{projectRef}/epics | Create a new epic |
| [**createEpicAcceptanceCriteria**](EpicsApi.md#createepicacceptancecriteria) | **POST** /projects/{projectRef}/epics/{epicRef}/acceptance-criteria | Add acceptance criteria to an epic |
| [**deleteEpic**](EpicsApi.md#deleteepic) | **DELETE** /projects/{projectRef}/epics/{epicRef} | Delete an epic |
| [**deleteEpicAcceptanceCriteria**](EpicsApi.md#deleteepicacceptancecriteria) | **DELETE** /projects/{projectRef}/epics/{epicRef}/acceptance-criteria/{criteriaId} | Delete acceptance criteria from an epic |
| [**getEpic**](EpicsApi.md#getepic) | **GET** /projects/{projectRef}/epics/{epicRef} | Get an epic |
| [**getEpicAcceptanceCriteria**](EpicsApi.md#getepicacceptancecriteria) | **GET** /projects/{projectRef}/epics/{epicRef}/acceptance-criteria/{criteriaId} | Get a specific acceptance criteria for an epic |
| [**listEpicAcceptanceCriteria**](EpicsApi.md#listepicacceptancecriteria) | **GET** /projects/{projectRef}/epics/{epicRef}/acceptance-criteria | List acceptance criteria for an epic |
| [**listEpicDependencies**](EpicsApi.md#listepicdependencies) | **GET** /projects/{projectRef}/epics/{epicRef}/dependencies | List epics this epic depends on |
| [**listEpicTasks**](EpicsApi.md#listepictasks) | **GET** /projects/{projectRef}/epics/{epicRef}/tasks | List tasks in an epic |
| [**listEpics**](EpicsApi.md#listepics) | **GET** /projects/{projectRef}/epics | List epics in a project |
| [**removeEpicDependency**](EpicsApi.md#removeepicdependency) | **DELETE** /projects/{projectRef}/epics/{epicRef}/dependencies/{depEpicRef} | Remove a dependency from an epic |
| [**updateEpic**](EpicsApi.md#updateepicoperation) | **PUT** /projects/{projectRef}/epics/{epicRef} | Update an epic |
| [**updateEpicAcceptanceCriteria**](EpicsApi.md#updateepicacceptancecriteria) | **PUT** /projects/{projectRef}/epics/{epicRef}/acceptance-criteria/{criteriaId} | Update acceptance criteria for an epic |
